...
DEMO = (
    ...
    ('eval-demo1-8 gauss     20 10000 10', '32 2 32', '0.25 0.75 0.25', '20 v[0-9]*9$'),
#    ('eval-demo1-32 exp     100 100000 10', '32 2 128', '0.25 0.75 0.50', '10 v[0-9]*9$'),
#    ('eval-demo1-256 exp     100 100000 10', '256 2 128', '0.25 0.75 0.50', '10 v[0-9]*9$'),
   
#    ('eval-demo2-8a exp   100 100000 10', '8 1 128', '0.984375 1.0 0.25', '10 v[0-9]*9$'),
#    ('eval-demo2-8 exp   100 100000 10', '8 1 128', '0.25 0.75 0.125', '10 v[0-9]*9$'),
#    ('eval-demo2-32 exp   100 100000 10', '32 1 128', '0.25 0.75 0.125', '10 v[0-9]*9$'),
#    ('eval-demo2-256 exp   100 100000 10', '256 1 128', '0.25 0.75 0.125', '10 v[0-9]*9$'),
